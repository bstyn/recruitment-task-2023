...
export function getType(rootElement?: ElementsType){
    switch(rootElement.type){
        case 'textTile':
            return(<TextBlock key={rootElement.elementKey} {...rootElement}></TextBlock>)
        case 'imageTile':
            return(<ImageBlock key={rootElement.elementKey} {...rootElement}></ImageBlock>)
        case 'buttonTile':
            return(<ButtonBlock key={rootElement.elementKey}  {...rootElement}></ButtonBlock>)
        case 'verticalSplitter':
            return(<VerticalBlock key={rootElement.elementKey} {...rootElement}></VerticalBlock>)
        case 'horizontalSplitter':
            return<HorizontalBlock key={rootElement.elementKey} {...rootElement}></HorizontalBlock>
    }
